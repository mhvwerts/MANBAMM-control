...
![Schematic of connection between LG16 sensor and Arduino UNO board](https://github.com/mhvwerts/MANBAMM-control/MOLTECH-flow-sensor-system/res/LG16-xxxxD-i2cconnectionarduino.png)
